...
const FirstBootScreen = ({navigation}: {navigation: any}) => {
let t:any= null;
    
const transistionEndOfAnim = (navigation:any, time:number) =>{
    t=setTimeout(()=>{navigation.navigate('GenderScreen')},time);
}
  return (
    <View>
        <Animatable.View {...decorationAnim} onAnimationEnd={()=>transistionEndOfAnim(navigation,1500)}>
